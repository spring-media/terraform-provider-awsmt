...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("awsmt_source_location.test_source_location", "default_segment_delivery_configuration.dsdc_base_url", "https://ott-mediatailor-test.s3.eu-central-1.amazonaws.com/test-img.jpeg"),
					resource.TestCheckResourceAttr("awsmt_source_location.test_source_location", "http_configuration.hc_base_url", "https://ott-mediatailor-test.s3.eu-central-1.amazonaws.com"),
					...
					resource.TestCheckResourceAttr("awsmt_source_location.test_source_location", "segment_delivery_configurations.0.sdc_base_url", "https://example.com/"),
			...
			// Update and Read testing
			{
				Config: `resource "awsmt_source_location" "test_source_location"{
							access_configuration = {
  							...
  							default_segment_delivery_configuration = {
    							dsdc_base_url = "https://example.com/"
  							}
							segment_delivery_configurations = [{
    							sdc_base_url = "https://example.com/"
								sdc_name = "default"
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("awsmt_source_location.test_source_location", "source_location_name", "test_source_location"),
					resource.TestCheckResourceAttr("awsmt_source_location.test_source_location", "http_configuration.hc_base_url", "https://ott-mediatailor-test.s3.eu-central-1.amazonaws.com/"),
					resource.TestCheckResourceAttr("awsmt_source_location.test_source_location", "default_segment_delivery_configuration.dsdc_base_url", "https://example.com/"),
